...
CREATE TABLE `productoterminado` (
  ...
  CONSTRAINT `productoterminado_fk4` FOREIGN KEY (`idUbicacion`) REFERENCES `ubicacion` (`id`),
...
CREATE TABLE `importacion` (
  ...
  PRIMARY KEY (`id`),
  KEY `idCompra` (`idCompra`),
  CONSTRAINT `importacion_fk` FOREIGN KEY (`idCompra`) REFERENCES `compra` (`id`)
